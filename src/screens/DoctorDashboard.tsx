...
export function DoctorDashboard() {
  ...
  const { tokens, updateTokenStatus, updateDoctorStatus } = useApp();
  ...
  return (
    <div className="flex h-screen bg-[var(--neutral-50)] font-sans">
      ...
      <aside className="w-56 bg-white border-r border-[var(--neutral-200)] flex flex-col flex-shrink-0">
        ...
        {/* Doctor self-status controls */}
        <div className="px-3 pb-2 border-t border-[var(--neutral-200)] pt-3 space-y-1">
